    ...
    <header className="sticky top-0 z-20 animate-fade-up bg-black/85 backdrop-blur-xl border-b border-white/10" style={{ animationDelay: '100ms' }}>
      <div className="px-[clamp(1.4rem,4vw,3rem)] py-4 flex items-center justify-between gap-5">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:inline-flex items-center gap-2 rounded-full border border-white/15 px-3.5 py-2">
            <div
              className="animate-pulse-dot rounded-full w-[6px] h-[6px] bg-accent"
              style={{ boxShadow: '0 0 12px var(--color-accent), 0 0 24px rgba(127,212,245,0.3)' }}
            />
            <p className="font-display text-[0.66rem] font-semibold tracking-[0.22em] uppercase text-muted">
              Launching 2026
            </p>
          </div>
