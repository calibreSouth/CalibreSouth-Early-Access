  ...
  return (
    <section className="relative z-10 overflow-hidden bg-black px-[clamp(1.4rem,4vw,3rem)] py-24 md:py-36 border-b border-white/10">
      ...
      <div className="relative flex flex-col items-center text-center">
        <div ref={quoteRef} className="manifesto-item font-display font-black leading-[0.92] uppercase text-fg"
          style={{ fontSize: 'clamp(2.8rem, 7vw, 7rem)', letterSpacing: '0' }}>
          One city.<br /><span className="text-accent drop-shadow-[0_0_24px_rgba(127,212,245,0.55)]">Every way to move.</span>
        </div>
      </div>
    </section>
  )
